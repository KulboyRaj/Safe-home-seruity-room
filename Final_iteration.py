...
message = "no_message"
flag2 = False
client = Client("AC67909901f0623582ce6f570506d4a2bb", "e7165d2370e833833310ea97046966c7")
...
def sendmail(img_no):
    ...
    msg = EmailMessage()
    msg['Subject'] = "Alert!!!!"
    msg['From'] = '@gmail.com'       #send mail fuunction
    msg['To'] = '@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
        smtp.login('@gmail.com','your pass')
